...
class Sender
{
    ...
    {
        if(!sc.hasOwn(client, 'send') || typeof client.send !== 'function'){
            ErrorManager.error('Required method "send" not found in client.');
        }
        if(!sc.hasOwn(client, 'broadcast') || typeof client.broadcast !== 'function'){
            ErrorManager.error('Required method "broadcast" not found in client.');
        }
        if(!sc.hasOwn(client, 'send') || typeof client.send !== 'function'){
            ErrorManager.error('Property "send" found in client but is not a function.');
        }
        if(!sc.hasOwn(client, 'broadcast') || typeof client.broadcast !== 'function'){
            ErrorManager.error('Property "broadcast" found in client but is not a function.');
        }
    }
