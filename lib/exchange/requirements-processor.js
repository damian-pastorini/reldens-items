...
class RequirementsProcessor
{
    ...
    constructor(props)
    {
        ...
        this.requirementsByItemKey = sc.get(props, 'requirementsByItemKey', false);
    }
    ...
    validateRequirements(inventoryKeyFrom, exchange)
    {
        ...
        for(let i of pushedForExchangeItemsKeys){
            ...
            this.requirementsValidation(itemRequirements, pushedForExchangeItemsKeys, inventoryKeyTo, exchange);
        }
    ...
    requirementsValidation(itemRequirements, pushedForExchangeItemsKeys, inventoryKeyTo, exchange)
    {
        ...
        for(let requirement of itemRequirements){
            ...
            let pushedForExchangeItemQty = pushedForExchangeItemsKeys[i];
            if((requirement.requiredQuantity * pushedForExchangeItemQty) > requiredInventoryItem.qty){
                return false;
            }
            ...
            if(requirement.requiredQuantity > requiredItemForExchange){
                exchange.lastErrorMessage = this.requiredItemQuantityNotAvailable(requirement, inventoryKeyTo);
                return false;
            }
        }
        return true;
